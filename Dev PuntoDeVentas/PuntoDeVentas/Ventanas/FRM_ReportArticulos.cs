...
{
    public partial class FRM_ReportArticulos : Form
    {

        #region  <DECLARACIONES>

        string Qry =
        "SELECT * FROM TBL_VENTAS_X_ARTICULO_VIEW WHERE FECHA BETWEEN FORMAT('@START_DATE','SHORT DATE') AND FORMAT('@END_DATE','SHORT DATE')";
        ...
        private void cmdAceptar_Click(object sender, EventArgs e)
        {
            ...
            wndReportView.ReportTitle = "Reporte Ventas x Articulo";
