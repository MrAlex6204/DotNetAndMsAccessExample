...
public static class Functions {
    ...
    public static void MostrarCambio(string Text, string Total, string Pago, string Cambio, System.Windows.Forms.Form OwnerForm) {
        PuntoDeVentas.FRM_Cambio wndMessage = new PuntoDeVentas.FRM_Cambio();
        wndMessage.Message = Text;

        if (OwnerForm != null) {
            wndMessage.ShowDialog(OwnerForm);
        } else {
            wndMessage.ShowDialog();
        }
